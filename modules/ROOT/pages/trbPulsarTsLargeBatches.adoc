...
You can decrease the batch size by lowering the number of records collected in each batch (xref:cfgRefPulsarDseConnection.adoc[maxNumberOfRecordsInBatch]).
The default is 32.
