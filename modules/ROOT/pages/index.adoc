...
* Open source Apache Cassandra(R) 2.1 and later (non-EOL versions recommended)
...
See the xref:pulsarQuickStart.adoc[] for an introduction to connecting Pulsar to DataStax Enterprise using the DataStax Pulsar Connector and sending simple key/value messages using the Pulsar client utility.
