...
The DataStax Apache Pulsar Connector processes JSON, Avro, and complex types, such as Pulsar https://docs.confluent.io/current/clients/confluent-pulsar-dotnet/api/Confluent.Pulsar.html#structs[Structs] or maps, directly into a link:/en/dse/6.7/cql/cql/cql_using/useAlterType.html[user-defined type] column in the link:pulsarIntro.md#pulsarIntroduction[supported database].
