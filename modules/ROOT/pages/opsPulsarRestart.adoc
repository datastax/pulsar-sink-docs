...
Restart the DataStax Apache Pulsar™ Connector .
...
If a task fails and then a change is made to correct the issue, use the xref:pulsarRestartTasks.adoc[Restart Task] command to rerun the task.
