...
NOTE: To capture these metrics, the xref:config-reference:cfgRefPulsarDseConnection.adoc[jmx] parameter must be set to `true` in the DataStax Apache Pulsar® Connector configuration file.
