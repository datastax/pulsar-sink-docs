...
The sink name refers to a configured and running {product} sink, and metric class is the general class of the metric, such as `Count` or `SnapShotSize`.
...
Integer count for various {product} metrics.
