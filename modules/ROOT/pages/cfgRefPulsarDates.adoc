...
To write to a column with data type xref:dse-6.9@cql:reference:data-types.adoc#date-and-time-types[timestamp], for the test Pulsar topic string field that contains `2018-03-09T17:12:32.584+01:00[Europe/Paris]`, use the setting:
...
To write to a column with type xref:dse-6.9@cql:reference:data-types.adoc#date-and-time-types[date] for a Pulsar topic that contains a string field like "2018-04-12", use the setting:
...
To write to a column with type xref:dse-6.9@cql:reference:data-types.adoc#date-and-time-types[time] for a Pulsar topic string field like "10:15:30", use setting:
