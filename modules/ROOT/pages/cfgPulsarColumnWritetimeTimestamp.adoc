[#pulsarColumnWritetimeTimestamp]
= Specify writetime timestamp column
:imagesdir: _images

Optionally specify the column to use for the writetime timestamp when inserting records from Pulsar into supported database tables.
