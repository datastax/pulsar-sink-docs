...
. Use the `cqlsh` command `xref:dse-6.9@cql:cqlsh:cqlsh-commands/describe-table.adoc[DESCRIBE TABLE]` to verify that the field isn't mapped to a xref:dse-6.9@cql:data-modeling:methodology.adoc[primary key (PK) column].
+
