...
----
+
NOTE: When the xref:cfgRefPulsarDseConnection.md[contactPoints] parameter is missing, the `localhost`; this assumes the database is co-located on the DataStax Apache Pulsar Connector node.
+
