...
. Delete any sinks associated with the DataStax Pulsar Connector:
+
...
----
. Stop the Apache Pulsar service:
+
[source,language-bash]
----
...
Shutdown completed.
----
. Remove the DataStax Pulsar Connector from the `connectors` directory:
+
[source,language-bash]
----
