...
Example - Pulsar topic named `my-topic` has 10 partitions and the connector group is configured to have link:configuration_reference/pulsarConnector.md#tasks_max[20 tasks].
