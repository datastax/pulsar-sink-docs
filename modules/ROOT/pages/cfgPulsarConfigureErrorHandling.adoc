[#_configure_error_handling_pulsarconfigureerrorhandling_reference]
= Configure error handling
:imagesdir: _images

Specifies whether Pulsar Connector should continue processing records even if an error occurred.
