...
With {product}, use the `ignoreErrors` parameter to specify how the connector handles runtime errors when processing messages from {pulsar-short} topics and writing them to database tables.
