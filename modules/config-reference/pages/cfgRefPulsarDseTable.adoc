[#_pulsar_topic_to_table_settings_pulsarcassandratable_reference]
...
Capture Pulsar topics in the link:../pulsarIntro.md#pulsarIntroduction[supported database] by specifying a target keyspace, table, and then map the topic fields to table columns in the name of the parameter.
