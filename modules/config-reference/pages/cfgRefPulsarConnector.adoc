...
Download the xref:../../dscloud/astra/dscloudObtainingCredentials.adoc[secure connect bundle] from the DataStax Cloud console.
 ...
 If this option is specified, you must also include the [auth.username](pulsarAuthLdap.md#username) and [auth.password](pulsarAuthLdap.md#password) for the database user.
