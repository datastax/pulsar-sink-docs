...
* xref:configure-reference-pulsar-auth-ldap.adoc[] When the cluster has internal or LDAP authentication enabled, you should configure the username and password settings for the Pulsar Connector.
