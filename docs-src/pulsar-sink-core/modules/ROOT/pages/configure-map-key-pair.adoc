...
. Create the keyspace.
Ensure that keyspace is replicated to a datacenter that is set in the DataStax Apache Pulsar Connector xref:configure-reference-pulsar-dse-connection.adoc#contactPoints[contactPoints] parameter.
...
.. Add the topic name to xref:configure-reference-pulsar-dse-table.adoc#topics[topics].
.. Define the topic-to-table map xref:configure-reference-pulsar-dse-table.adoc#prefix[prefix].
.. Define the xref:configure-reference-pulsar-dse-table.adoc#mapping[field-to-column map].
+
