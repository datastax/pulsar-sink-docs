...
You can decrease the batch size by lowering the number of records collected in each batch (xref:configure-reference-pulsar-dse-connection.adoc#maxNumberOfRecordsInBatch[maxNumberOfRecordsInBatch]).
The default is 32.
